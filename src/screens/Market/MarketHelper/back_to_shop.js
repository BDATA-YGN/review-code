...
const BackToShopDialog = ({visible, onConfirm, onCancel, darkMode}) => {
  return (
    <Modal
      transparent={true}
      animationType="slide"
      ...
      <View style={styles.overlay}>
        <View
          ...
          <Text
            ...
            The item has been successfully added to your cart. Do you want to
...
export default BackToShopDialog;
