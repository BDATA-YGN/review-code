...
const FriendRequestShimmer = (props) => {
  ...
  const shimmerViews = Array.from({length: props.shimmerCount ? props.shimmerCount : 1}).map((_, index) => (
...
export default FriendRequestShimmer;
